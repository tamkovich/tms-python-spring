...
dict_trains = [
    ...
    },
    {
        'Номер_поезда': 1189,
        'Пункт_прибытия': 'Минск',
        'Время_прибытия': datetime(2021, 6, 8, 13, 33, 0),
        'Пункт_отбытия': 'Львов',
        'Время_отбытия': datetime(2021, 6, 7, 23, 10, 0)
    },
    {
        'Номер_поезда': 1344,
        'Пункт_прибытия': 'Минск',
        'Время_прибытия': datetime(2021, 9, 1, 12, 13, 0),
        'Пункт_отбытия': 'Лида',
        'Время_отбытия': datetime(2021, 9, 1, 8, 43, 0)
    },
]
