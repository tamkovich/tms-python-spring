# Задание 3_10
# Получить на ввод количество рублей, копеек и вывести в правильной форме, например: 3 рубля, 1 рубль 25 копеек, 3 копейки
...
# Также программа выводит слова "рубль" и "копейка" с правильными окончаниями в зависимости от привязанных к ним чисел
